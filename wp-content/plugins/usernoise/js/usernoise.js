...
jQuery(function($){
  ...
  function UsernoiseButton(){
		...
		self.showWindow = function(){
		  var $overlay = $('<div id="un-overlay" />').prependTo($('body'));
		  $overlay.fadeIn('fast');
		  var $loading = $('<div id="un-loading" />').prependTo($('body'));
			var $iframe = $('<iframe id="un-iframe" marginheight="0" marginwidth="0" frameborder="0" allowtransparency="true" />').prependTo($('body'));
